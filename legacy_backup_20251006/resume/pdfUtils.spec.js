...
describe('pdfUtils - 100% DI Coverage', () => {
  let instance;
  ...
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new pdfUtils();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new pdfUtils(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new pdfUtils(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(pdfUtils.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new pdfUtils({
