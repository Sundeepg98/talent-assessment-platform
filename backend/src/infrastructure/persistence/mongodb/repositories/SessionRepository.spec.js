...
describe('SessionRepository - 100% Coverage', () => {
  let repository;
  let mockModel;
  ...
  beforeEach(() => {
    ...
    repository = new SessionRepository(mockModel);
  });
  ...
  describe('Repository Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(SessionRepository.prototype)
  ...
  describe('Error Handling', () => {
    ...
    it('should handle null model', async () => {
      const nullRepo = new SessionRepository(null);
