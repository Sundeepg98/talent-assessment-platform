const Disable2FAUseCase = require('./Disable2FAUseCase');

describe('Disable2FAUseCase - 100% DI Coverage', () => {
  let instance;
  ...
  beforeEach(() => {
    ...
    instance = new Disable2FAUseCase(mockDependencies);
  });
  
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new Disable2FAUseCase();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new Disable2FAUseCase(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new Disable2FAUseCase(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(Disable2FAUseCase.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new Disable2FAUseCase({
