const ResendVerificationUseCase = require('./ResendVerificationUseCase');

describe('ResendVerificationUseCase - 100% DI Coverage', () => {
  let instance;
  ...
  beforeEach(() => {
    ...
    instance = new ResendVerificationUseCase(mockDependencies);
  });
  
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new ResendVerificationUseCase();
      expect(emptyInstance).toBeDefined();
    });
    
    it('should accept injected dependencies', () => {
      expect(instance).toBeDefined();
      expect(instance._repository || instance.repository).toBeDefined();
      expect(instance._service || instance.service).toBeDefined();
      expect(instance._eventBus || instance.eventBus).toBeDefined();
    });
    
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new ResendVerificationUseCase(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new ResendVerificationUseCase(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(ResendVerificationUseCase.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new ResendVerificationUseCase({
        repository: { execute: () => ({ success: true }) },
        service: { execute: () => ({ success: true }) },
        eventBus: { execute: () => ({ success: true }) }
      });
