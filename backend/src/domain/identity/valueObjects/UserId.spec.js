...
describe('UserId - 100% DI Coverage', () => {
  let instance;
  ...
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new UserId();
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(UserId.prototype)
