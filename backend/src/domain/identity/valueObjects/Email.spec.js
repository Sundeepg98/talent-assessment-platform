...
describe('Email - 100% DI Coverage', () => {
  let instance;
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(Email.prototype)
