const ISessionRepository = require('./ISessionRepository');

describe('ISessionRepository - 100% DI Coverage', () => {
  let instance;
  ...
  beforeEach(() => {
    ...
    instance = new ISessionRepository(mockDependencies);
  });
  
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new ISessionRepository();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new ISessionRepository(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new ISessionRepository(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(ISessionRepository.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new ISessionRepository({
