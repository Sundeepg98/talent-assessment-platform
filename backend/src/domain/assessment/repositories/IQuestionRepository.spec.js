const IQuestionRepository = require('./IQuestionRepository');

describe('IQuestionRepository - 100% DI Coverage', () => {
  let instance;
  ...
  beforeEach(() => {
    ...
    instance = new IQuestionRepository(mockDependencies);
  });
  
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new IQuestionRepository();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new IQuestionRepository(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new IQuestionRepository(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(IQuestionRepository.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new IQuestionRepository({
