...
describe('Entity - 100% DI Coverage', () => {
  let instance;
  ...
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new Entity();
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(Entity.prototype)
