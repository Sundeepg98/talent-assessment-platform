...
describe('embeddingService - 100% DI Coverage', () => {
  let instance;
  ...
  beforeEach(() => {
    ...
    instance = new embeddingService(mockDependencies);
  });
  
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new embeddingService();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new embeddingService(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new embeddingService(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(embeddingService.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new embeddingService({
