const mockJudge0Service = require('./mockJudge0Service');

describe('mockJudge0Service - 100% DI Coverage', () => {
  let instance;
  ...
  beforeEach(() => {
    ...
    instance = new mockJudge0Service(mockDependencies);
  });
  
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new mockJudge0Service();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new mockJudge0Service(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new mockJudge0Service(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(mockJudge0Service.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new mockJudge0Service({
