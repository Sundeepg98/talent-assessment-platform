...
describe('fileValidator - 100% DI Coverage', () => {
  let instance;
  ...
  describe('Constructor', () => {
    it('should create instance without dependencies', () => {
      const emptyInstance = new fileValidator();
    ...
    it('should handle null dependencies gracefully', () => {
      const nullInstance = new fileValidator(null);
      expect(nullInstance).toBeDefined();
    });
    
    it('should handle undefined dependencies gracefully', () => {
      const undefinedInstance = new fileValidator(undefined);
  ...
  describe('Methods', () => {
    ...
    const methods = Object.getOwnPropertyNames(fileValidator.prototype)
  ...
  describe('Integration', () => {
    it('should work with real implementations', () => {
      ...
      const realInstance = new fileValidator({
